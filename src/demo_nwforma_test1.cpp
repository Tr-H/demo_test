...
while(ros::ok())
	{
		...
		pos_will_write[id].type = 3;//pos[id].type;
...
int main(int argc, char **argv)
	...
	for (i=0;i<4;i++)
		...
		*/
		forma_shape[1].delta_x = 0.5196f;
		forma_shape[1].delta_y = 0.3f;
		//forma_shape[1].delta_x = 1.2f;
		forma_shape[0].delta_x = -0.5196f;
		forma_shape[0].delta_y = 0.3f;
		forma_shape[2].delta_x = 0.0f;
		forma_shape[2].delta_y = -0.6f;
